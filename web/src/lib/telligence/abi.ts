...
export const telligenceDeployerAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "inputs": [
      {
        "name": "doubling",
        "type": "uint8",
        "internalType": "enum TelligenceDoubling"
      }
    ],
    "outputs": [
      {
    ...
    "inputs": [
      {
        "name": "machine",
        "type": "tuple",
        "internalType": "struct TelligenceMachine",
        "components": [
          {
            "name": "name",
            "type": "string",
          ...
          },
          {
            "name": "keep",
            "type": "uint8",
            "internalType": "enum TelligenceKeep"
          },
          {
            "name": "doubling",
            "type": "uint8",
          ...
          },
          {
            "name": "routes",
            "type": "tuple[]",
            "internalType": "struct TelligenceRoute[]",
            "components": [
              {
                "name": "projectId",
                "type": "uint64",
  ...
  {
    "type": "error",
    "name": "TelligenceDeployer_NoMachine",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TelligenceDeployer_NoStartTime",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TelligenceDeployer_RoutesExceedKeep",
    "inputs": [
      {
        "name": "totalPercent",
        "type": "uint256",
