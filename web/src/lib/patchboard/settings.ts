...
const EXPERIMENT_BASE: CableFeel = {
  ...
  grip: 0.14, stretch: 0.02, plugWeight: 3,
  shapeMemory: true, socketAssist: true,
};
...
export const FEEL_PRESETS: Record<string, CableFeel> = {
  ...
  "Soft cable": { ...EXPERIMENT_BASE, bend: 0.25, settling: 2, damping: 1.6, cordFriction: 0.4, grip: 0.2, plugWeight: 2 },
  "Heavy rubber": { ...EXPERIMENT_BASE, bend: 3, settling: 16, damping: 4.5, cordFriction: 1.15, floorFriction: 1.2, grip: 0.1, plugWeight: 4.5 },
