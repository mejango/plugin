...
export const FEEL_PRESETS: Record<string, CableFeel> = {
  ...
  "Soft cable": { ...DEFAULT_FEEL, bend: 0.25, settling: 2, damping: 1.6, cordFriction: 0.4, grip: 0.2, plugWeight: 2, socketResistance: 0.12 },
  "Heavy rubber": { ...DEFAULT_FEEL, bend: 3, settling: 16, damping: 4.5, cordFriction: 1.15, floorFriction: 1.2, grip: 0.1, plugWeight: 4.5, socketResistance: 0.34 },
  "Firm + fast settling": { ...DEFAULT_FEEL, bend: 5, settling: 24, damping: 5 },
};
