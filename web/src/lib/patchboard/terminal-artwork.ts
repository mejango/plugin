...
export function drawMachineTerminal(ctx: CanvasRenderingContext2D, layout: ScreenLayout, sx: number, sy: number, state: MachineReadout) {
  ...
  pixels(screen,state.mode??"top",14,12,2,"#090e16");
  ...
  ctx.font=`600 ${size*.2}px ui-sans-serif, system-ui, sans-serif`;ctx.textAlign="center";ctx.textBaseline="middle";ctx.fillStyle="#153d4b";ctx.fillText("NOW",kx,ky+size*.08);
